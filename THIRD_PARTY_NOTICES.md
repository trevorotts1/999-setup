...
This repository bundles two third-party Claude Code skills under their MIT licenses.
Each skill folder carries a full copy of its upstream license; this file records the
upstream source and the exact commit vendored, so licensing stays traceable.
