...
- `VIOLATION-STOP 2026-08-16T21:05Z: wave 7 in ledger not in locked table and no NEW-WAVE-7 dependency line: - \`WAVE 7 DISPATCH ...\` — conductor MUST TaskStop the named workstream and re-dispatch from its last clean checkpoint`
